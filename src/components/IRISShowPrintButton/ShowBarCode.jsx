...
const showPrintButton = (showPrintButtonGlobal, href) => ((!showPrintButtonGlobal && href) ? <Button
    ...
    <Icon
        ...
        className="btnIcon" /> <span>{Constants.IRISCouponPrintLabel}</span>
</Button> : null);
        ...
        if (printOption.href && printConfig) {
            printHtml = (<Button
                ...
                <Icon
                    ...
                    name="barcode"
                    pathClassName={styles.lockBtnIcon}
                    className="btnIcon" /> <span>{Constants.CouponPrintLabel}</span>
            </Button>);
        }
        return (
            (printOption.href && printConfig && offerDetails.barCode) ?
            (<div className={cx('coupon', 'couponBarcode')}>
                <Button
                    ...
                    <Icon
                        ...
                        viewBox="0 0 35 35"
                        name="barcode"
                        className={cx('barcodeIcon')} />Print Barcode
                    </Button>
                <ModalBox
            ...
            </div>) : <div className={cx('printBtnBlock')}>{showPrintButton(this.props.showPrintButtonGlobal, printOption.href)}</div>
        );
    }
